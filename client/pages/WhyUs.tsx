          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="order-first lg:order-last">
              <div className="relative">
                <div className="aspect-[4/3] bg-gradient-to-br from-accent/10 to-background rounded-lg overflow-hidden">
                  <img
                    src="https://cdn.builder.io/api/v1/image/assets%2Fc46db2117e2947fb97b0993642d34356%2Fb252bacc2770427ca0ef20fda285adfc?format=webp&width=800"
                    alt="Warm photo of family relaxing by fireplace looking at their illuminated home"
                    className="w-full h-full object-cover"
                  />
                </div>
              </div>
